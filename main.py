...
ACCESS_TOKEN = os.getenv("LINE_ACCESS_TOKEN", "j1+7ySCSdNuQZ8U8/gFEH4v3MiIymXSQgUSDlCciHMMlWY43CGSmvd4eY2NojXWhzELBl6DrsKftxexOFSEB/FkmyyAiXN8r74JP2ggZGJyw2U8spZ+TYh6C2lyyNZ5W55xbMMP3ytFaunx/qah6twdB04t89/1O/w1cDnyilFU=")
CHANNEL_SECRET = os.getenv("LINE_CHANNEL_SECRET", "e937c6acf3a39432c76118e66f9f9365")

# ข้อมูล Gemini api key
GEMINI_API_KEY = os.getenv("GEMINI_API_KEY", "AIzaSyBF01Hf1zJWRpzZ3PZ5_q5BikbDl14-EiM")
...
async def lifespan(app: FastAPI):
    ...
    sample_documents = [
        "ศุภกร แสงจิต คือ ชายหนุ่มนักศึกษาสาขาวิทยาการคอมพิวเตอร์ คณะวิทยาการสารสนเทศ มหาวิทยาลัยบูรพา",
        "ศุภกร แสงจิต มีชื่อเล่นว่า พี เกิดวันที่ 13 พฤศจิกายน 2546 ที่จังหวัดชลบุรี จบการศึกษามัธยมปลายจากโรงเรียนชลราษฎรอำรุง",
        "งาน BUU-Bootcamp-2024 จัดที่มหาวิทยาลัยบูรพา ในวันที่ 12 ธันวาคม ปีค.ศ.2024 โดยมีการจัดกิจกรรมต่าง ๆ ที่เกี่ยวข้องกับการพัฒนาซอฟต์แวร์ การเรียนรู้เอไอ เวลา 8:30 น. - 16:30 น.",
        "ClickNext Team AI มีสมาชิก  คน "
    ]
